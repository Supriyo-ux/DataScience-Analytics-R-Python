####Manual opgtimization, you can jump to code number 4#####
...
#ROCR plot
plot(roc_data_sorted$one_minus_specificity,roc_data_sorted$sensitivity,xlab="1-Specificity",
     ylab="Sensitivity",type="l",main="ROC curve")
